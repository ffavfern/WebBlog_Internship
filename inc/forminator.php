...
class Change_Forminator_Upload_Dir {
	...
	public function __construct() {
		add_action('forminator_custom_form_before_save_entry', [$this,'my_form_change_upload_dir',]);
		add_action('forminator_custom_form_after_save_entry', [$this,'my_form_restore_upload_dir',]);
	}
