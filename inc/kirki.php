...
Kirki::add_field( 'plant', [
	...
	'output' => [
		...
		[
			'choice'   => 'hover',
			'element'  => 'header.site-header li a:hover, header.site-header li:hover a, header.site-header li:hover .si-down',
			'property' => '--s-accent-hover',
        ],
		[
			'choice'   => 'active',
...
Kirki::add_field( 'plant', [
	...
	'output' => [
        ...
        [
			'choice'   => 'link',
			'element'  => '.site-header .site-nav-m a',
			'property' => '--s-text',
		],
		[
			'choice'   => 'border',
...
Kirki::add_field( 'plant', [
	...
	'description' => __( 'Example: https://m.me/seedthemes', 'plant' ),
	'section'     => 'chat_buttons',
	'type'        => 'text',
	'active_callback' => [
		[ 
...
Kirki::add_field( 'plant', [
	...
	'description' => __( 'Example: https://fb.com/seedthemes', 'plant' ),
	'section'     => 'chat_buttons',
	'type'        => 'text',
	'active_callback' => [
		[ 
 ...
 * Hide Plant Theme
 */
if (get_theme_mod( 'hide_plant_theme', '0' )) { 
...
if ( ! function_exists( 'plant_var' ) ) {
	function plant_var() {
		...
		$GLOBALS['s_blog_archive_profile']  = (get_theme_mod( 'blog_archive_profile', '0' ))? 'enable' : 'disable';
...
if ( ! function_exists( 'plant_css' ) ) {
	function plant_css() {
		...
		$header_center_menu		= get_theme_mod( 'header_center_menu', '0');
		...
		$hide_title_m 			= get_theme_mod( 'hide_title_m','0');
		$body_title_hidden		= get_theme_mod( 'body_title_hidden','0');
		$blog_archive_profile   = get_theme_mod( 'blog_archive_profile','0');
