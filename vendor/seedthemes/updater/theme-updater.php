...
$updater = new EDD_Theme_Updater_Admin(
	...
	// Config settings
	$config = array(
		'remote_api_url' => 'https://seedwebs.com', // Site where EDD is hosted
		'item_name'      => 'Plant: ธีมอเนกประสงค์', // Name of theme
		'theme_slug'     => 'plant', // Theme slug
		'version'        => '2.3.4', // The current version of this theme
		'author'         => 'Seed Webs', // The author of this theme
		'download_id'    => '59789', // Optional, used for generating a license renewal link
	...
	$strings = array(
		...
		'enter-key'                 => __( 'Enter Plant theme license key. You can find from <a href="https://seedwebs.com/account/" target="_blank">Account Page</a>.', 'plant' ),
