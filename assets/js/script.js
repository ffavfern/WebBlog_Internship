    ...
    (n.SlickCarousel = function () {
      e(".full-slider-mode")
        ...
        .slick({
          ...
          infinite: true,
          nextArrow:
            '<span class="slide-icon slide-icon-1 slide-next icon-right fas fa-angle-right"></span>',
          prevArrow:
            '<span class="slide-icon slide-icon-1 slide-prev icon-left fas fa-angle-left"></span>',
      ...
      e(".posts-slider").not(".slick-initialized").slick({
        ...
        infinite: true,
        nextArrow:
          '<i class="slide-icon slide-icon-1 slide-next icon-right fas fa-angle-right"></i>',
        prevArrow:
          '<i class="slide-icon slide-icon-1 slide-prev icon-left fas fa-angle-left"></i>',
        rtl: rtl_slick(),
      });
      e("#aft-trending-story-five .trending-posts-carousel")
        ...
        .slick({
          ...
          infinite: true,
          nextArrow:
            '<i class="slide-icon slide-icon-1  slide-next fas fa-angle-down"></i>',
          prevArrow:
            '<i class="slide-icon slide-icon-1 slide-prev fas fa-angle-up"></i>',
