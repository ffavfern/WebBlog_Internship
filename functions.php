...
function seed_admin($hook) {
    ...
    if ('post.php' == $hook) {
        wp_enqueue_script('s-admin', get_theme_file_uri('/js/page-salepage-admin.js'), array(), false, true);
    }
}
...
function plant_register_required_plugins() {
	$plugins = array(
        array(
			'name'               => 'Kirki',
			'slug'               => 'kirki',
			'source'             => get_template_directory() . '/vendor/kirki/kirki.3.1.6.zip',
			'required'           => true,
			'version'            => '3.1.6',
		...
		array(
			...
			'source'             => get_template_directory() . '/vendor/nextend/smartslider3-wordpress-PRO-3.5.0.6.zip',
			'required'           => false,
			'version'            => '3.5.0.6',
        ...
        array(
			...
			'source'             => get_template_directory() . '/vendor/ocdi/one-click-demo-import.3.0.2.zip',
			'required'           => false,
			'version'            => '3.0.2',
			'force_activation'   => false,
			'force_deactivation' => false,
